...
namespace osu.Game.Rulesets.Lines.Objects
{
    ...
    {
        public double TimePreempt = 1500;
        public double TimeFadeIn = 300;
        public double TimeAction = 150;
        public double TimeDelayRingFactor = 0.3;
        public double TimeRingFadeInFactor = 0.1;

        public double TimeDelayRing { get => TimePreempt * TimeDelayRingFactor; }
        public double TimeRingFadeIn { get => TimePreempt * TimeRingFadeInFactor; }
        public double TimeBeforeRing { get => TimeDelayRing; }
        ...
        {
            get => PositionBindable.Value + HitObjectOffsetBindable.Value;
            set => PositionBindable.Value = value;
        }

        public Bindable<Vector2> HitObjectOffsetBindable = new Bindable<Vector2>();
        ...
        public LinesHitObject PreviousObject;
