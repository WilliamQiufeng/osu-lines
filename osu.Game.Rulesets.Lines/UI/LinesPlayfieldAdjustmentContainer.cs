...
{
    public class LinesPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
        ...
        public LinesPlayfieldAdjustmentContainer()
        {
        ...
        private class ScalingContainer : Container
        {
            ...
            protected override void Update()
            {
                ...
                // Scale = 819.2 / 512
                // Scale = 1.6
                Scale = new Vector2(Parent.ChildSize.X / LinesPlayfield.BASE_SIZE.X);
